...
- querAvancar: true quando o cliente demonstra PRESSA ou pede OBJETIVIDADE, sem necessariamente pedir transferência. Vale para "tenho pouco tempo", "vamos direto ao assunto", "sem enrolação", "para de perguntar", "quanto custa logo", "me manda o preço", "quero resolver rápido", "muita pergunta". É diferente de querFalarComHumano: aqui ele não pediu ninguém, só quer que o atendimento ANDE. Marque false quando ele estiver conversando normalmente, mesmo que responda curto.
